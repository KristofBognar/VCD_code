function [dscd_S, rcd_S, avg_vcd] = get_no2_vcds_v2018(dscd_S, lambda, tag, sza_range, save_fig,working_dir,code_path,filter_tag)
...
[dscd_S.scd, dscd_S.scd_err_sys, dscd_S.scd_err_rand] = calc_scds_no2_v2018(dscd_S, rcd_S);
